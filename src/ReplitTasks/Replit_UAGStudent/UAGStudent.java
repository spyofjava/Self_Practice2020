...
public class UAGStudent {
    ...
    public static void newPrincipal(String PrName){
    ...
    public String toString() {
        return  name +" "+ studentID +" "+principalName;
    }
}
/*
...
Note: studentID is composed of the student's first
 initial in uppercase followed by the nextID

2. Constructors
Main constructor takes in name and grade only.
When the main constructor is called, it generates a student's ID
by combining the student's first initial in uppercase combined with
 the next ID.  The nextID should then be increased by 1.
